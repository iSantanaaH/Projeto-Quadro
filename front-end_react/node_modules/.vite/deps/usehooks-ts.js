...
var useBoolean_default = useBoolean;

// node_modules/usehooks-ts/dist/esm/useClickAnyWhere/useClickAnyWhere.js
function useClickAnyWhere(handler) {
  useEventListener_default("click", (event) => {
    handler(event);
  });
}
var useClickAnyWhere_default = useClickAnyWhere;
...
function useCountdown(countdownOption) {
  ...
  const { count, increment, decrement, reset: resetCounter } = useCounter_default(countStart);
  const { value: isCountdownRunning, setTrue: startCountdown, setFalse: stopCountdown } = useBoolean_default(false);
  ...
  useInterval_default(countdownCallback, isCountdownRunning ? intervalMs : null);
  return isDeprecated ? [
    count,
    {
...
function useDarkMode(defaultValue) {
  var _a;
  const isDarkOS = useMediaQuery_default(COLOR_SCHEME_QUERY);
  const [isDarkMode, setDarkMode] = useLocalStorage_default("usehooks-ts-dark-mode", (_a = defaultValue !== null && defaultValue !== void 0 ? defaultValue : isDarkOS) !== null && _a !== void 0 ? _a : false);
...
function useHover(elementRef) {
  ...
  useEventListener_default("mouseenter", handleMouseEnter, elementRef);
  useEventListener_default("mouseleave", handleMouseLeave, elementRef);
  return value;
}
...
var useImageOnLoad_default = useImageOnLoad;
...
var useReadLocalStorage_default = useReadLocalStorage;
...
var useScreen_default = useScreen;
...
function useSessionStorage(key, initialValue) {
  ...
  useEventListener_default("storage", handleStorageChange);
  useEventListener_default("session-storage", handleStorageChange);
  return [storedValue, setValue];
}
...
var useStep_default = useStep;

// node_modules/usehooks-ts/dist/esm/useTernaryDarkMode/useTernaryDarkMode.js
var import_react28 = __toESM(require_react());
var COLOR_SCHEME_QUERY2 = "(prefers-color-scheme: dark)";
function useTernaryDarkMode() {
  const isDarkOS = useMediaQuery_default(COLOR_SCHEME_QUERY2);
  const [ternaryDarkMode, setTernaryDarkMode] = useLocalStorage_default("usehooks-ts-ternary-dark-mode", "system");
...
var useTernaryDarkMode_default = useTernaryDarkMode;
...
function useUpdateEffect(effect, deps) {
  const isFirst = useIsFirstRender_default();
...
export {
  ...
  useDocumentTitle_default as useDocumentTitle,
  ...
  useImageOnLoad_default as useImageOnLoad,
  useIntersectionObserver_default as useIntersectionObserver,
  useInterval_default as useInterval,
  useIsClient_default as useIsClient,
  useIsFirstRender_default as useIsFirstRender,
  useIsMounted_default as useIsMounted,
  ...
  useReadLocalStorage_default as useReadLocalStorage,
  useScreen_default as useScreen,
  useScript_default as useScript,
  useSessionStorage_default as useSessionStorage,
  useSsr_default as useSsr,
  useStep_default as useStep,
  useTernaryDarkMode_default as useTernaryDarkMode,
